...
struct _RrPixmapMask {
    ...
    gint height;
    gchar *data;
    /* TRUE when the mask came from a real theme file, FALSE when it fell
       back to a tiny built-in glyph; used by the fork to decide between
       rendering the theme's XBM icon or a vector fallback */
    gboolean from_theme;
};
