        ...
        do {
...

            {
                ...
                if ((config_file &&
                    ...
                    obt_xml_load_config_file(i, "stellarbox", "rc.xml",
                                             "openbox_config"))
                {
...
static void print_help(void)
{
    ...
    g_print(_("\nPassing messages to a running Stellarbox instance:\n"));
    g_print(_("  --reconfigure       Reload Stellarbox's configuration\n"));
    g_print(_("  --restart           Restart Stellarbox\n"));
    g_print(_("  --exit              Exit Stellarbox\n"));
    g_print(_("\nDebugging options:\n"));
